"""基于 bird_dog p1/p2 参数的实时计数叠加视频测试."""
...
CONFIG_PATH = PROJECT_ROOT / "config" / "action_configs" / "bird_dog_trained.json"
SPLIT_PATH = PROJECT_ROOT / "data" / "datasets" / "bird_dog_v1.0_split.json"
OUTPUT_DIR = PROJECT_ROOT / "output" / "tests"
OUTPUT_PATH = OUTPUT_DIR / "bird_dog_test_count_overlay.mp4"
...
def test_bird_dog_realtime_count_overlay_video_generation() -> None:
    ...
    count_layer = {
        ...
        "timing": {"min_cycle_distance_frames": 40, "min_phase_duration_sec": 0.2}
    }
    ...
    print(f"Total counted reps for bird_dog: {counter.rep_count}")
