"""基于 side_lift p1/p2 参数的实时计数叠加视频测试."""
...
CONFIG_PATH = PROJECT_ROOT / "config" / "action_configs" / "side_lift_trained.json"
SPLIT_PATH = PROJECT_ROOT / "data" / "datasets" / "side_lift_v1.0_split.json"
OUTPUT_DIR = PROJECT_ROOT / "output" / "tests"
OUTPUT_PATH = OUTPUT_DIR / "side_lift_test_count_overlay.mp4"
...
def test_side_lift_realtime_count_overlay_video_generation() -> None:
